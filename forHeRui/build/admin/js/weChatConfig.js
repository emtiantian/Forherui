...
//			}						
			...
			tdHtml += '<td ><input class="form-control" id="Wechat_department" type="text" value="' + ele.department + '" /></td>';
			tdHtml += '<td ><input class="form-control" id="Wechat_Position" type="text" value="' + ele.Position + '" /></td>';
			switch(ele.Gender) {
				case 1: 
					tdHtml += '<td > <select id="Wechat_Gender"><option value="1" selected="selected">男</option><option value="2">女</option></select></td>';
					break;
				case 2:
